...
; so the next bootloader stage is loaded here, which will be jumped to afterwards.
...
; kernel will be loaded into memory at address 0x10000 (over 100KiB available here)
KERNEL_ADDR = 0x10000
